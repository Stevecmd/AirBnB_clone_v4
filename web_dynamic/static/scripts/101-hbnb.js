// Loads all data on startup unlike code 2
// /* global $ */
...
$(document).ready(function () {
  ...
  function updateLocations() {
    const locations = Object.values(selectedStates).concat(
        ...
        for (const place of data) {
          ...
          information.append(
            `<div class="number_rooms">${
              place.number_rooms || "N/A"
            } Bedroom${place.number_rooms !== 1 ? "s" : ""}</div>`,
          );
          information.append(
            `<div class="number_bathrooms">${
              place.number_bathrooms || "N/A"
            } Bathroom${place.number_bathrooms !== 1 ? "s" : ""}</div>`,
          );
          article.append(information);
